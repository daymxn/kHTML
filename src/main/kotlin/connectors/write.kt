 ...
 */
infix fun <T: HTMLElement> T.write(element: HTMLElement) = this ex element
 ...
 * @see additionalwaystoaddelements
 */
infix fun <T: HTMLElement> T.write(elements: List<HTMLElement>) = this ex elements
 ...
 * @see additionalwaystoaddelements
 */
infix fun <T: HTMLElement> T.write(text: String) = this txt text
 ...
 * the same signature as another [write].
 *
 * @param texts a list of text to add.
 * @see additionalwaystoaddelements
 */
fun <T: HTMLElement> T.write(vararg texts: String) = texts.forEach { this txt it }
